# -*- coding: utf-8 -*-
# Generated by Django 1.11.22 on 2019-08-05 11:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('uodated_at', models.DateTimeField(auto_now=True, verbose_name='修改时间')),
        ...
        migrations.AddField(
            ...
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_login', to='accounts.User'),
        ),
    ]
