...
class Classify(models.Model):
    ...
    name = models.CharField('分类名称', max_length=12)
...
class Product(models.Model):
    ...
    sku_count = models.IntegerField('库存')
    ...
    classes = models.ManyToManyField(Tag, verbose_name='分类', related_name='classes', null=True, blank=True)
