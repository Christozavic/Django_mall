    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reorder', models.SmallIntegerField(default=0, verbose_name='排序')),
                ('status', models.SmallIntegerField(choices=[(11, '销售中'), (22, '已售完'), (33, '已下架')], default=33, verbose_name='商品状态')),
                ('sku_count', models.IntegerField(verbose_name='库存')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('img', models.ImageField(blank=True, null=True, upload_to='tags', verbose_name='标签主图')),
        ...
        migrations.AddField(
            model_name='product',
            name='classes',
            field=models.ManyToManyField(related_name='classes', to='mall.Tag', verbose_name='分类'),
        ),
        migrations.AddField(
            model_name='product',
            name='tags',
