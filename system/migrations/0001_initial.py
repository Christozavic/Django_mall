# -*- coding: utf-8 -*-
# Generated by Django 1.11.22 on 2019-08-03 15:26
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('view_conut', models.IntegerField(default=0, verbose_name='浏览次数')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(upload_to='slider', verbose_name='图片')),
                ('reorder', models.SmallIntegerField(default=0, help_text='数字越大越靠前', verbose_name='排序')),
                ('start_time', models.DateTimeField(blank=True, null=True, verbose_name='生效开始时间')),
                ('end_time', models.DateTimeField(blank=True, null=True, verbose_name='生效结束时间')),
